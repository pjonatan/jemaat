...
public class PLansia extends JFrame implements Printable {

    
	private static final long serialVersionUID = 1L;
	private String data[][]=null;
	private String column[] = {"Nama","Alamat", "Tgl Lahir","Phone"};	
	private int rows=0;
    	...
    	int count=0;
    		while(rs.next()){
    			...
    			if((tahun - ls) >55 || (tahun - ls)==55){
    		  		for(int i=1;i<=4;i++){
    		  			data[count][i-1]=rs.getString(i+1);
    		  		}
    				count++;
    			 }	
    		}
